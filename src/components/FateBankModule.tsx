        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
              Войди в мир мистических контрактов и судьбоносных решений. 
              Здесь каждое действие имеет последствия, а каждый выбор меняет будущее...
            </p>
                ...
                <div className="relative h-full flex flex-col justify-between">
                  <div className="text-center">
                    ...
                    <p className="text-gray-300 text-lg leading-relaxed mb-6 group-hover:text-white transition-colors">
                      Заключи договор с тёмными силами. 
                      Отправь своё послание в бездну и получи ответ судьбы...
                    </p>
                  </div>
              ...
              <div className="relative bg-gradient-to-br from-gray-900/80 to-black/80 border border-purple-500/30 rounded-2xl p-8 h-80 backdrop-blur-sm transition-all duration-500 hover:border-purple-500/60 hover:shadow-2xl hover:shadow-purple-500/20 hover:scale-105">
                ...
                <div className="relative h-full flex flex-col justify-between">
                  <div className="text-center">
                    ...
                    <p className="text-gray-300 text-lg leading-relaxed mb-6 group-hover:text-white transition-colors">
                      Запусти колесо судьбы и позволь мистическим силам решить твою участь. 
                      Что уготовили тебе боги?
                    </p>
                  </div>
          ...
          <div className="text-center mt-16">
            <div className="bg-gradient-to-r from-gray-900/50 to-black/50 border border-gray-600/30 rounded-xl p-6 backdrop-blur-sm max-w-4xl mx-auto">
              <div className="flex items-center justify-center space-x-4 mb-4">
                ...
                <h4 className="text-xl font-bold text-red-400">Предупреждение от Рюка</h4>
                <span className="text-3xl animate-pulse">🕵️</span>
              </div>
              <p className="text-gray-300 leading-relaxed">
                "Хе-хе... Люди такие забавные! Думают, что могут контролировать судьбу. 
                Но помни - каждое действие имеет последствия, а каждый контракт меняет твою жизнь. 
                Играй осторожно, человек..."
              </p>
              <p className="text-blue-400 text-sm mt-2 italic">
                - L добавляет: "Вероятность случайности в судьбе составляет ровно 50%. Остальное зависит от тебя."
              </p>
            </div>
          </div>
        </div>
